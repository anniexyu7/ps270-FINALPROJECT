...
dataplot <- ggplot(data_long, 
  ...
  scale_x_discrete(labels = c(
    ...
    "no_sud_rearrest" = "No Substance Use Present")) +
...
`followup_period`     1-Year, 2-Years, or 3-Year check-up on participants

`num_releases`        number of individuals released at a given year
...
```
 ...
 Here’s our primary programs report that we put out a few years ago. Substance Use Disorder (SUD) treatment, which would be given primarily to people with a drug history (though not necessarily those with a drug offense, and this would not include EVERY person with a drug history, just those who took the program) is included in this report.
