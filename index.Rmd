...
raoodata_summary <- raoodata |>
  summarize(
    ...
    "Public Order Offenses" = mean(total_recid_prop_perc * 100),
    "Violent Crime Offenses" = mean(total_recid_vio_perc * 100)) |>
  pivot_longer(
    cols = everything(), 
    names_to = "Offense Type", 
    values_to = "Average Recidivism Rate (%)") |>
