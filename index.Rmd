...
As shown in the visualization, the bootstrapping model isn't compatible with the dataset, because ___. We can see that the visualization is skewed __ due to the ____. An F-statistic is being used instead of difference in proportions or difference in means, because I am trying to measure the variability between the rearrest rates of 4 types of crime. Additionally, I am trying to evaluate whether the difference in the average rearrest rates are statistically significant compared to the overall variability in the data. 
